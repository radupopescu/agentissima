...
answer was cut off by `max_tokens` rather than finished, and `peak memory`
should be a little above the model's on-disk size — a much smaller figure means
process discovery matched a helper rather than the backend.
